...
public: \
	DECLARE_CLASS(AVaultDoor, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/HeistTime"), NO_API) \
...
#define FID_HeistTime_Source_HeistTime_VaultDoor_h_13_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AVaultDoor); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AVaultDoor); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AVaultDoor(AVaultDoor&&); \
	NO_API AVaultDoor(const AVaultDoor&); \
public:
...
template<> HEISTTIME_API UClass* StaticClass<class AVaultDoor>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_HeistTime_Source_HeistTime_VaultDoor_h
